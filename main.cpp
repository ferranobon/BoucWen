...
int main(int argc, char **argv) {
    ...
    if (bwParameters.size() == BoucWen::NewtonRhapson::BoucWen<double_t>::NUM_PARAMS) {
        BWen = new BoucWen::NewtonRhapson::BoucWen<double_t>(bwParameters.data());
    } else if (bwParameters.size() == BoucWen::NewtonRhapson::BoucWen_Deg<double_t>::NUM_PARAMS) {
        BWen = new BoucWen::NewtonRhapson::BoucWen_Deg<double_t>(bwParameters.data());
    } else if (bwParameters.size() == BoucWen::NewtonRhapson::BoucWen_BaberNoori<double_t>::NUM_PARAMS) {
